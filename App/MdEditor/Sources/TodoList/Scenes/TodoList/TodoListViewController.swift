...
extension TodoListViewController {
	...
	override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
		...
		sectionView?.accessibilityIdentifier = AccessibilityIdentifier.TodoListViewController.section(
			index: section
		).description
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		cell.accessibilityIdentifier = AccessibilityIdentifier.TodoListViewController.cell(
...
private extension TodoListViewController {
	...
	private func setupUI() {
		...
		self.tableView.accessibilityIdentifier = AccessibilityIdentifier.TodoListViewController.tableView.description
	}
