...
private extension FileItemTableViewCell {
	...
	func layout() {
		let newConstraints = [
			imageViewIcon.topAnchor.constraint(equalTo: topAnchor, constant: Sizes.Cell.Padding.normal),
			...
			imageViewIcon.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -Sizes.Cell.Padding.normal),
			...
			labelSecondaryText.topAnchor.constraint(
				equalTo: labelText.topAnchor
			),
			labelSecondaryText.leadingAnchor.constraint(
				equalTo: labelText.trailingAnchor,
				constant: Sizes.Cell.Padding.half
			),
			labelSecondaryText.trailingAnchor.constraint(
				equalTo: trailingAnchor,
				constant: -Sizes.Cell.Padding.normal
			),
